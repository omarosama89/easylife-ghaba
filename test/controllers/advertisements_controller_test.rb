...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post advertisements_url, params: { advertisement: { image: @advertisement.image, text: @advertisement.text } }, as: :json
    end
  ...
  test "should update advertisement" do
    patch advertisement_url(@advertisement), params: { advertisement: { image: @advertisement.image, text: @advertisement.text } }, as: :json
    assert_response 200
  end
